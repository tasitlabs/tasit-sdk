...
- [A pub/sub API for Ethereum contracts perfect for optimistic updates](#a-pub/sub-api-for-ethereum-contracts-perfect-for-optimistic updates)
...
#### Onboarding with contract-based accounts or deep-linking to mobile wallets
