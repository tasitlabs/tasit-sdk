...
// ethers tests in tasit-act will look different than the truffle tests
...
contract("SampleContract", function(accounts) {
  ...
  // Note that this is different behavior from ethers
  // See more: packages/action/test/ethers.test.ts
